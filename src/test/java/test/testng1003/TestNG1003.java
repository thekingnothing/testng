...
public class TestNG1003 extends SimpleBaseTest {
  ...
  private TestNG createTestNG() {
    final TestNG tng = create(FailedInvocationTest.class);
  ...
  public static final class SimpleClassLoader extends ClassLoader {
    ...
    private boolean shouldBeLoadedWithDelegate(String name) {
      return "org.testng.SkipException".equals(name) || "test.testng1003.FailedInvocationTest".equals(name) ||
